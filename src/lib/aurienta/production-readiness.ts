...
export const WS1_DATABASE: WorkstreamItem[] = [
  ...
  { itemId: "DB-05", item: "Database indexes on all foreign keys + query hotpaths", status: "PASS", owner: "DBA", evidence: "18 @@index directives added to 6 FK-heavy models (User, OwnershipRecord, Vote, SyndicateMember, DripEnrollment, InsuranceVault); applied to live Turso DB; total explicit indexes: 132", notes: "Resolved 2026-09-02 as part of production-readiness audit remediation" },
